...
[英文版方法描述](src/method_B_C_PB.pdf)

[信息分析方法说明](src/analysis_method_B_C_PB.pdf)

[结果文件目录说明](src/Result_file_directory_PB.pdf)
...
- **[31] Liu B, Pop M. ARDB-antibiotic resistance genes database[J]. Nucleic acids research, 2009, 37(suppl 1): D443-D447.**
- **[32] Jia B, Raphenya A R, Alcock B, et al. CARD 2017: expansion and model-centric curation of the comprehensive antibiotic resistance database[J]. Nucleic Acids Research, 2017, 45(Database issue):D566-D573.**
- **[33] Kurtz S, Phillippy A, Delcher A L, et al. Versatile and open software for comparing large genomes[J]. Genome biology, 2004, 5(2): R12.**
- **[34] Harris R S. Improved pairwise alignment of genomic DNA[M]. ProQuest, 2007.**
- **[35] Chiaromonte F, Yap V B, Miller W. Scoring pairwise genomic sequence alignments[C]//Pacific Symposium on Biocomputing. 2001, 7: 115.**
...
- **[37] Krzywinski, M. et al. Circos: an Information Aesthetic for Comparative Genomics. Genome Res (2009) 19:1639-1645**
