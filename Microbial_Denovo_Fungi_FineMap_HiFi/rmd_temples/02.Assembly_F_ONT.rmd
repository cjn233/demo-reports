...
&emsp;&emsp;使用Flye软件(https://github.com/fenderglass/Flye，version：2.9-b1768) 进行基因组组装，得到能反映样品基因组基本情况的初步的组装结果，然后使用 Racon（version：1.4.13）软件基于三代测序数据对拼接结果进行三轮纠错后，再进行三轮二代 reads 的 Pilon（version：1.22）纠错，得到最终的组装结果，组装结果如下表所示：
