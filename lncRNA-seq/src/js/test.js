...
if(document.getElementById("ERm")){
        ...
        volg = echarts.init(document.getElementById("VOLGENE")),
            volg.setOption({
                ...
                tooltip: {
                    ...
                    formatter: function (params) { if (params.value[0] > 0 && params.value[1] > 1.3) { return 'UP:<br>id: ' + (params.value[2] + '<br>log2Fc: ' + params.value[0] + '<br>-log10(padj): ' + params.value[1]); } else if (params.value[0] < 0 && params.value[1] > 1.3) { return 'DOWN:<br>id: ' + (params.value[2] + '<br>log2Fc: ' + params.value[0] + '<br>-log10(padj): ' + params.value[1]); } else if (params.value[1] < 1.3) {return 'NULL:<br>id: ' + (params.value[2] + '<br>log2Fc: ' + params.value[0] + '<br>-log10(padj): ' + params.value[1]);} },
                                        textStyle: {
                        fontSize: 14
                    },
                    itemStyle: {
    ...
    if (document.getElementById("VOLCIRC")) {
        volc = echarts.init(document.getElementById("VOLCIRC")),
            volc.setOption({
                color: [function (params) { if (params.value[0] > 0 && params.value[1] > 1.3) { return '#FF0033'; } else if (params.value[0] < 0 && params.value[1] > 1.3) { return '#009966'; } return '#0066CC'; }],
                title: {
                ...
                series: [{symbolSize: 5.5,
                    ...
                    symbol: ['none', 'none'], 
                    data: [{lineStyle: {color: "#FF8C00",},
                    yAxis: 1.3 }]
                        }
                    }
                ] 
            }),f = document.getElementById("volcname"),
            f.onchange = function () {
                volcnow = f.options[document.getElementById("volcname").options.selectedIndex].value,
                    pvolc = document.getElementById("pvolc"),
                    nvolc = document.getElementById("nvolc"),
                    volcircs = volcirc_data[volcnow], volc.setOption({ series: [{ data: volcircs }] })
            }; $("#pvolc").click(function () {
                f.selectedIndex = f.selectedIndex - 1, nvolc.style.visibility = "visible", -1 == f.selectedIndex && (f.selectedIndex = $("#volcname").find("option:first").index(), pvolc.style.visibility = "hidden"), f.onchange();
            }), $("#nvolc").click(function () {
                f.selectedIndex = f.selectedIndex + 1, pvolc.style.visibility = "visible", -1 == f.selectedIndex && (f.selectedIndex = $("#volcname").find("option:last").index(), nvolc.style.visibility = "hidden"), f.onchange();
            })
    };
